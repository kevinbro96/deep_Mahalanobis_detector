...
def main():
    ...
    #adv_test_list = ['BIM', 'FGSM',  'PGD', 'CW', 'PGD-L2', 'CW-L2']#, 'BIM', 'FGSM',  'DeepFool', 'CWL2']
    adv_test_list = ['BIM', 'FGSM', 'PGD', 'CW']#, 'PGD-L2', 'CW-L2']
    print('evaluate the KD estimator')
    score_list = ['KernelDensity_100','KernelDensity_500', 'KernelDensity_1000']
    list_best_results_kd, list_best_results_index_kd = [], []
    for dataset in dataset_list:
        ...
        list_best_results_kd.append(list_best_results_out)
        list_best_results_index_kd.append(list_best_results_index_out)
    ...
    print("results of KernelDensity")
    for in_list in list_best_results_kd:
        ...
        for results in in_list:
            ...
            print('Input noise: ' + list_best_results_index_kd[count_in][count_out])
            print('')
            count_out += 1
        count_in += 1
