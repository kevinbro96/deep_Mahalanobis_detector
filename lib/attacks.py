...
class XAttack(nn.Module):
    def __init__(self, model,  eps_max=8/255, step_size=None,  num_iterations=7, datasets='cifar10', norm='linf', rand_init=True, scale_each=False, loss='ce'):
        super().__init__()
    ...
    def forward(self, img, labels):
        ...
        return self.normalize(adv_sample), s.data.max(1)[1]
